...
class OfferController extends Controller
{
    ...
    //create function to store offer
    ...
    public function delete(ProjectOffers $offer)
    {
        $offer->delete();
    ...
    public function accept(ProjectOffers $offer, Request $request)
    {
        ...
        return  $this->jsonSuccess(200, "Offer Approved Successfully",null, "offer");
    ...
    public function sign(ProjectOffers $offer, Request $request)
    {
        ...
        return $this->jsonSuccess(200, "Signed Off", new ProjectOfferResource($offer), "offer");
    }
