        ...
        <div class="row justify-content-center">
            <div class="col-lg-6">
                <div class="appie-error-content text-center">
                    ...
                    <dotlottie-player src="https://lottie.host/e2f2af06-39f3-4e5f-a92c-f6bbe7b57ae7/o5OeoJa7ph.json" background="transparent" speed="1" style="width: 600px; height: 300px;" loop autoplay></dotlottie-player>
                    <h3 class="title">Your account has been verified successfully</h3>
                    <p>Now you can go to your account</p>
                    <br />

                        <div class="appie-btn-box text-center">
                            <a class="main-btn ml-30" href="http://localhost:3000/dashboard">Go to account</a>
                        </div>
